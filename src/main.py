...
if __name__ == '__main__':
    ...
    parser.add_argument('--clustering', default=4, type=int, help='[-2, -1, 0, 1] Optimize via Clustering or not')
    ...
    parser.add_argument('--patience', type=int, default=50, help='Patience.') # num_train_epochs 200, patience 40
